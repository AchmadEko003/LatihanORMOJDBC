...
public class JobFrame extends javax.swing.JFrame {
    ...
    private void btnInsertMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInsertMouseClicked
        ...
        if (dialogResult == 0) {
            if (!jobId.equals("") && !jobTitle.equals("") && !minSalary.equals("") && !maxSalary.equals("")) {
                if (jc.insertJob(jobId, jobTitle, minSalary, maxSalary)) {
    ...
    private void btnSearchIdMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSearchIdMouseClicked
        ...
        try {
                String isi1 = String.valueOf(no);
                String isi2 = jc.getByIdJob(txtSearchId.getText()).getJobId();
                String isi3 = jc.getByIdJob(txtSearchId.getText()).getJobTitle();
                String isi4 = String.valueOf(jc.getByIdJob(txtSearchId.getText()).getMinSalary());
                String isi5 = String.valueOf(jc.getByIdJob(txtSearchId.getText()).getMaxSalary());
    ...
    private void btnDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteMouseClicked
        ...
        if (dialogResult == 0) {
            if (!jobId.equals("")) {
                if (jc.deleteJob(jobId, jobTitle) == true) {
