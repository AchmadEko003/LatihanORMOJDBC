...
public class DepartmentView extends javax.swing.JInternalFrame {
    ...
    private void getDatas(List<Department> dep){
        ...
        try {
            ...
            for (Department department : dep) {
                ...
                String isi3 = employee.getFirstName()+" "+employee.getLastName();
    ...
    private void btnSearchIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchIdActionPerformed
        ...
        try {
                int no = 1;
                String isi0 = String.valueOf(no);
                String isi1 = Short.toString(dc.getDepartmentId(txtSearchId.getText()).getDepartmentId());
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // TODO add your handling code here:
        getDatas(dc.getSearch(txtSearch.getText()));
